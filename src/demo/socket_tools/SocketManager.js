...
function getURI(loginData) {
    const domain = "app.real-api.online";
    return `wss://${domain}/login?user_name=${loginData.userName}&app_key=${loginData.appKey}&app_secret=${loginData.appSecret}&prod_key=${loginData.prodKey}&ins_id=${loginData.insID}`;
}
